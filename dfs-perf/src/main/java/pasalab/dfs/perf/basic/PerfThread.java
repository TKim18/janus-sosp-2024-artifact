...
public abstract class PerfThread implements Runnable {
   ...
   * 
   * @param taskConf
   * @param closeFileSystem whether to close the file system during cleanup
   * @return true if cleanup successfully, false otherwise
   */
  public abstract boolean cleanupThread(TaskConfiguration taskConf, boolean closeFileSystem);
}
