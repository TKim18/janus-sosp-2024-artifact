...
public class TestCase {
  ...
  private Map<String, String> mIterations;
  ...
  private TestCase(String xmlFileName) throws Exception {
    ...
    mIterations = saxTestCase.getIterations();
  ...
  /**
   * Get the number of iterations of specified task.
   *
   * @param type
   * @return
   * @throws Exception
   */
  public int getIteration(String type) throws Exception {
    String iteration = mIterations.get(type);
