...
public class PerfFileSystemHdfs extends PerfFileSystem {
  ...
  private PerfFileSystemHdfs(String path, String hdfsImpl) {
    ...
    mConf.set("dfs.replication", "2");
    mConf.set("dfs.blocksize", "8388608");
    mConf.set("dfs.client.read.striped.threadpool.size","30");
	mConf.set("dfs.client.retry.max.attempts","8");
	mConf.set("dfs.client.write.max-packets-in-flight","300");    
	mConf.set("dfs.client.hedged.read.threadpool.size","12");
	mConf.set("dfs.client.hedged.read.threshold.millis","300");
