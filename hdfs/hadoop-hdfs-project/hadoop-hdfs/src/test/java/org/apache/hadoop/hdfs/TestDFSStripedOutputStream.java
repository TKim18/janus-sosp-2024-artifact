...
//    multiTest("/hybrid_FullBlockGroup", fileSize);
    testOneFile("/FullBlockGroup", fileSize);
...
//      LOG.info("SHUTTING OFF DATANODE {}", cluster.getDataNodes().get(0).getXferAddress());
      cluster.stopDataNode(DFSStripedOutputStream.datanodeToKill.getXferAddr());
//      cluster.stopDataNode(DFSStripedOutputStream.datanodeToKill2.getXferAddr());
