...
all_space, time = combine_files('/proj/HeARTy/ceridwen-sosp-2024-artifact/scripts/result/' + sys.argv[1] + '/space')
all_space = ignore_low_diff(all_space, 1048576)

# write out all space to output directory
with open(os.path.join('/proj/HeARTy/ceridwen-sosp-2024-artifact/scripts/result/' + sys.argv[1] + '/output'), "w") as f:
